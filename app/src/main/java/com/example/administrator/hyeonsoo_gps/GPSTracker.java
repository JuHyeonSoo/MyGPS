...
/////////////////////////////////////////////////////////////////
//이 Class는 GPS에 관한 기본적 method 들이 담김.★
//서비스도 함께 포함한 Class여서 서비스 부분이 수정필요.  ★★★
//주기적으로 위치정보를 확인하며 Activity에 나와야하지만, 그렇지 못하고 있음.★★★
//예를 들어, GPS 위치 정보가 Update() 되도 화면의 TextView 에서 수정되질 않음.★★★
...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000 * 30; // 30sec
    ...
    ///////////////////////////////////////////////////////////////////////
    //Service를 manifest에 등록하려면 만들어야 한데서 만듦. 큰 의미는 없음.
    public GPSTracker() {
    }
    ///////////////////////////////////////////////////////////////////////
    public void Update(){
    ...
    public Location getLocation() {
        ...
        try {
            ...
            // getting GPS status      :활성화 여부
            isGPSEnabled = locationManager
                    .isProviderEnabled(LocationManager.GPS_PROVIDER);

            // getting network status     :활성화 여부
            isNetworkEnabled = locationManager
                    .isProviderEnabled(LocationManager.NETWORK_PROVIDER);

            if (!isGPSEnabled && !isNetworkEnabled) {
                // no network provider is enabled  :모두 비활성화인 경우
            } else {
                ...
                if (isNetworkEnabled ) {
                    ...
                    if (locationManager != null) {
                        ...
                        if (location != null) {
                            latitude = location.getLatitude(); //data.setLatitude(location.getLatitude());
                            longitude = location.getLongitude();//data.setLongitude(location.getLongitude());
                        }
                    }
                }
